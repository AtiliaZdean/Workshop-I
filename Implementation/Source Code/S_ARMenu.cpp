...
int S_ARMenu::prompt(int selected) 
{
...
void S_ARMenu::addOption(string text, string value) 
{
	items.push_back({ text,value });
}

void S_ARMenu::clearOption() 
{
	items.clear();
}

void S_ARMenu::setValue(int index, string value) 
{
